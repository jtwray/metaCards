...
const metaCardsRouter=require('../metaCards/router.js')


server.use('/api/metaCards', metaCardsRouter);
...
server.get("/", (req, res) => {
    res.send("Its Alive! check your console for a secret message...tucker");
});
